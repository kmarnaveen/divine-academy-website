          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-xl text-gray-700 mb-8 leading-relaxed">
                Comprehensive sports facilities promoting physical fitness, team
                spirit, and competitive excellence. From recreational activities
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-600">
                Comprehensive sports infrastructure catering to all interests
                and skill levels
              </p>
            </motion.div>
                          ...
                          >
                            ...
                            <div className="space-y-3">
                              ...
                              <div>
                                ...
                                <div className="flex flex-wrap gap-1">
                                  {(facility.sports || facility.programs)?.map(
                                    (sport, idx) => (
                                      <Badge
                                        key={idx}
                                        variant="outline"
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-600">
                Celebrating our students' sporting excellence and competitive
                success
              </p>
            </motion.div>
                  ...
                  <div className="space-y-4">
                    {sportsCalendar.map((event, index) => (
                      <motion.div
                        ...
                        className="flex items-center gap-4 p-4 bg-primary-50 rounded-lg border-l-4 border-primary"
                      >
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-primary-100 mb-8 text-lg">
                Discover your sporting potential with our comprehensive
                programs, professional coaching, and world-class facilities.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
