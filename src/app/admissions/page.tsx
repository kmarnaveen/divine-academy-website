          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                <Badge className="mb-6 bg-white text-primary text-lg px-6 py-2 border border-white/20">
                  🎓 Admissions Open 2025-26 | Limited Seats Available
                </Badge>
                <h1 className="text-4xl md:text-6xl font-bold font-heading mb-6 leading-tight">
                  Your Child Deserves the{" "}
                  <span className="text-white font-bold">DIA Advantage</span>
                </h1>
                <p className="text-xl text-gray-200 leading-relaxed mb-8">
                  Join 1000+ families who've chosen excellence. Our simple
                  4-step admission process ensures your child starts their
                  transformational journey with us smoothly.
                </p>
                ...
                <div className="grid grid-cols-3 gap-4 mb-8">
                  <div className="text-center p-4 bg-white/10 rounded-lg backdrop-blur-sm">
                    ...
                    <div className="text-sm text-gray-200">Board Results</div>
                  </div>
                  <div className="text-center p-4 bg-white/10 rounded-lg backdrop-blur-sm">
                    <div className="text-2xl font-bold text-white">1:25</div>
                    <div className="text-sm text-gray-200">Teacher Ratio</div>
                  </div>
                  <div className="text-center p-4 bg-white/10 rounded-lg backdrop-blur-sm">
                    <div className="text-2xl font-bold text-white">13+</div>
                    <div className="text-sm text-gray-200">Years Trust</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white text-gray-900 rounded-2xl p-8 shadow-2xl">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600">
                    Book a campus visit and see why families choose DIA
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <Button
                    asChild
                    className="w-full bg-accent hover:bg-accent/90 text-primary font-semibold text-lg py-3"
                  >
                    <Link
                      href="#admission-form"
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="w-full border-2 border-primary text-primary hover:bg-primary hover:text-white font-semibold text-lg py-3"
                  >
                    <Link
                      href="#campus-visit"
                      className="flex items-center justify-center"
                ...
                <div className="mt-6 text-center text-sm text-gray-500">
                  ✓ No application fee • ✓ Same-day response • ✓ Personal
                  guidance
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We don't just promise excellence—we deliver it through proven
              programs and personalized attention.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50" id="process">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We've made admissions stress-free. Follow these simple steps to
              ...
              return (
                <div key={process.step} className="relative">
                  ...
                  {index !== admissionProcess.length - 1 && (
                    <div className="hidden lg:block absolute left-8 top-20 w-px h-20 bg-primary" />
                  )}
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Keep these documents ready to make your admission process smooth
              and quick.
            </p>
          </div>
          ...
          <div className="mt-12 text-center bg-accent-50 rounded-2xl p-8 max-w-4xl mx-auto">
            <AlertCircle className="h-12 w-12 text-accent-600 mx-auto mb-4" />
            <h3 className="text-xl font-bold text-primary mb-3">
              Need Help with Documents?
            </h3>
            <p className="text-gray-600 mb-6">
              Our admission counselors are here to guide you through the
              documentation process. Contact us for personalized assistance.
            </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Quality education at affordable fees. No hidden charges, complete
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <ul className="text-sm text-yellow-700 space-y-1">
                    ...
                    <li>
                      • Sibling discount: 10% on annual fees for second child
                      onwards
                    </li>
                    <li>
                      • Payment methods: Cash, Cheque, Online Transfer, UPI
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-8 text-primary-100">
              Join the DIA family and give your child the advantage of quality
              education, personal attention, and holistic development.
            </p>
